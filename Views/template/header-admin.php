        ...
        <div class="left side-menu">
            ...
            <div class="left-side-logo d-block d-lg-none">
                <div class="text-center">
                    <a href="index.html" class="logo"><img src="<?php echo BASE_URL; ?>public/img/logo-ens.png" height="50" alt="logo"></a>
                </div>
            </div>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="">
                            <a href="<?php echo BASE_URL . 'pedidos'; ?>" class="waves-effect"><i class="fas fa-shopping-cart mr-3"></i> <span> Pedidos </span> </a>
                        </li>
                        
                        <li class="">
                            <a href="<?php echo BASE_URL . 'ventas/historial'; ?>" class="waves-effect"><i class=" fas fa-list-alt mr-3"></i> <span> Historial </span> </a>
                        </li>
            ...
            <div class="content">
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-left	d-none d-lg-block">
                        <div class="text-center">
                            <a href="<?php echo BASE_URL; ?>" class="logo"><img src="<?php echo BASE_URL; ?>public/img/logo-ens.png" height="50" alt="logo"></a>
                        </div>
                    </div>
